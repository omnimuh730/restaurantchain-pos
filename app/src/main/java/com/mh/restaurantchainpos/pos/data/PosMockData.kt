...
object PosMockData {
    ...
    val staff = listOf(
        StaffMember("Jamie Chen", "jamie.chen", "Chef", "active", "Mar 2023", 2),
        StaffMember("Sam Rivera", "sam.rivera", "Waiter", "active", "Jun 2023", 4),
        StaffMember("Taylor Kim", "taylor.kim", "Cashier", "active", "Jan 2024", 9),
        StaffMember("Casey Park", "casey.park", "Cashier", "active", "Aug 2024", 8),
        StaffMember("Jordan Lee", "jordan.lee", "Waiter", "inactive", "Oct 2024", 4),
    )
